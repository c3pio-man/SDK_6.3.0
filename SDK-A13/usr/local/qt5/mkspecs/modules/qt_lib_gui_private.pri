...
QT.gui_private.enabled_features = xcb evdev freetype system-freetype fontconfig gif harfbuzz ico jpeg kms linuxfb multiprocess png system-jpeg system-png tuiotouch vnc xcb-glx xlib xcb-xlib xcb-native-painting xcb-render xcb-sm xinput2 xkb xrender
QT.gui_private.disabled_features = accessibility-atspi-bridge angle_d3d11_qdtd direct2d directfb egl egl_x11 eglfs eglfs_brcm eglfs_egldevice eglfs_gbm eglfs_mali eglfs_openwfd eglfs_rcar eglfs_viv eglfs_viv_wl eglfs_vsp2 integrityfb integrityhid libinput libinput-axis-api mirclient mtdev system-harfbuzz system-xcb tslib vsp2 xkbcommon-evdev xkbcommon-system
QMAKE_LIBS_XCB = -lxcb
